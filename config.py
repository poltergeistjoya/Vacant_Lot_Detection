...
class SamplingConfig(BaseModel):
    ...
    min_pixels: int = 50  # Minimum parcel size as NAIP pixel count (min_area_m2 = min_pixels × resolution²)
...
class CityConfig(BaseModel):
    ...
    def _run_key(self) -> str:
        """Return the run directory name: '{city}_{run_name}' or '{city}' if run_name matches city."""
...
- Min pixels: {config.sampling.min_pixels}
